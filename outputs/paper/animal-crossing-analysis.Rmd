...
```
```{r socio-demographic-profile, echo=FALSE}
...
Out of the 640 responses received, most of them were within their 20s (see Figure \@ref(fig:age)) and came from either a nationality of American or Canadian (see Table \@ref(fig: socio-demographic-profile)). Table \@ref(fig: socio-demographic-profile) and Figure \@ref(fig:age) both display all of the sociodemographic data obtained from the “Socio-demographic profile” section of the questionnaire. If we look at Table \@ref(fig: socio-demographic-profile), we see that most of the participants were female, completing their undergrad education, white, had a pet or garden at home (closely followed by just a pet), and were single (never married). 
